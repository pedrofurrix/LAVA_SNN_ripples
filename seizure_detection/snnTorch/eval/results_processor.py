...
for adapt in adapt:
    ...
    networks=[f"{common_identifier}_{idn}b" for idn in ids_networks] + ["iiss_adapt20_1b","iiss_adapt20_2b"]# + [f"{common_identifier}_{idn}f" for idn in ids_networks]
    ...
    list_nets=[
        {
            ...
            "spikes": os.path.join(os.path.dirname(os.path.abspath(__file__)),"live_results2","spikes",f"{spike}_spikes.npy")
        }
    ...
    results_dir=os.path.join(os.path.dirname(os.path.abspath(__file__)),"live_results2")
