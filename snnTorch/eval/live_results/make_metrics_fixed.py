...
metrics_filename= f"channel_metrics_by_network_{identifier}.csv"
metrics_df.to_csv(os.path.join(metrics_dir, metrics_filename), index=False)
kappa_filename= f"channel_kappa_by_network_{identifier}.csv"
metrics_dfk.to_csv(os.path.join(metrics_dir, kappa_filename), index=False)
